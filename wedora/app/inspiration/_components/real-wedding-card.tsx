  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col justify-center p-5 sm:p-6 flex-1">
        ...
        <p className="text-sm text-[#666666] dark:text-[#B0B0B0] leading-relaxed line-clamp-2 mb-3">
          {story.description}
        </p>
        <span className="inline-flex items-center gap-1 text-sm font-medium text-[#FF69B4] mt-auto">
